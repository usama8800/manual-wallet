...
const svgs = {
  ...
  delete: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <path d="M192 112V72h0a23.93 23.93 0 0124-24h80a23.93 23.93 0 0124 24h0v40M256 176v224M184 176l8 224M328 176l-8 224" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" stroke-width="32" />
  </svg>,
